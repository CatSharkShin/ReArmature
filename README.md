...
A [Resonite](https://resonite.com/) mod that adds functionality to SkinnedMeshRenderers. You can now add new clothes to your avatar even if they have new bones..

## Installation (Manual)
1. Install [BepisLoader](https://github.com/ResoniteModding/BepisLoader) for Resonite.
2. Download the latest release ZIP file (e.g., `CatSharkShin-ReArmature-1.0.0.zip`) from the [Releases](https://github.com/CatSharkShin/ReArmature/releases) page.
